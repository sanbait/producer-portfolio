        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-14 items-start">
          <div className="flex-1 lg:order-1">
            ...
            <FadeInSection delay={0.2}>
              ...
              >
                <p>
                  8+ лет опыта в геймдеве и геймификации. Запускаю продукты, пересобираю команды и процессы, нахожу системные ошибки, которые тормозят рост и съедают бюджет.
                </p>
                <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-5 items-stretch">
              ...
              >
                <div className="p-7 h-full flex flex-col" style={{ border: "1px solid rgba(0, 0, 0, 0.20)" }}>
                  ...
                  >
                    Могу разработать и запустить MVP/MLP любой сложности в кратчайшие сроки.
                  </p>
                </div>
              </div>
